...
driver.find_element(By.XPATH, "//input[@id='ap_password']").send_keys("Test")
driver.find_element(By.XPATH, "//input[@id='ap_password_check']").send_keys("Test")
...
#minimum 6 characters doesnt require number or special characters
