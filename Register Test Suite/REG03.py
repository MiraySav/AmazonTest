...
driver.find_element(By.XPATH, "//input[@id='ap_customer_name']").send_keys("Miray")
driver.find_element(By.XPATH, "//input[@id='ap_email']").send_keys("miraytest123")
driver.find_element(By.XPATH, "//input[@id='ap_password']").send_keys("Test123.")
driver.find_element(By.XPATH, "//input[@id='ap_password_check']").send_keys("Test123.")
...
#İsim soyisim istiyor ancak sadece isim yazınca kabul ediyor